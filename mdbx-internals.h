...
MDBX_INTERNAL int osal_ioring_fsync(osal_ioring_t *ior, mdbx_filehandle_t fd,
...
MDBX_INTERNAL int osal_ioring_check_fs_ecryptfs(osal_ioring_t *ior, mdbx_filehandle_t fd);
...
MDBX_INTERNAL int osal_ioring_removefile(osal_ioring_t *ior, const pathchar_t *pathname);
