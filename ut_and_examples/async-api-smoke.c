...
enum async_read_mode {
  ...
  async_read_sync_large_get,
  async_read_sync_large_get_ex,
  async_read_sync_large_lowerbound,
  async_read_sync_large_cursor_get,
  async_read_sync_large_cursor_batch,
  async_read_sync_large_cursor_scan,
  ...
  async_read_sync_cursor_get_to_key_lt,
  async_read_sync_cursor_get_to_key_lte,
  ...
  async_read_sync_cursor_scan_from_lt,
  async_read_sync_cursor_scan_from_lte,
  async_read_sync_cursor_scan_from_equal,
  async_read_sync_cursor_scan_from_gte,
  async_read_sync_cursor_scan_from_gt,
  async_read_sync_cursor_scan_from_upperbound,
  ...
  async_read_cursor_get_to_key_lt,
  async_read_cursor_get_to_key_lte,
  ...
  async_read_cursor_get_loop_from_lt,
  async_read_cursor_get_loop_from_lte,
  ...
  async_read_cursor_get_batches_from_lt,
  async_read_cursor_get_batches_from_lte,
  ...
  async_read_cursor_scan_from_lt,
  async_read_cursor_scan_from_lte,
...
static int exercise_async_read_path(const char *path, bool inject_fault, enum async_read_mode mode) {
  ...
  const bool sync_read = mode == async_read_sync_get || mode == async_read_sync_get_ex ||
                         ...
                         mode == async_read_sync_large_cursor_scan ||
                         ...
                         mode == async_read_sync_cursor_get_to_key_lt ||
                         mode == async_read_sync_cursor_get_to_key_lte ||
                         ...
                         mode == async_read_sync_cursor_scan_from_lte ||
                         mode == async_read_sync_cursor_scan_from_equal ||
                         mode == async_read_sync_cursor_scan_from_gte ||
                         mode == async_read_sync_cursor_scan_from_gt ||
                         mode == async_read_sync_cursor_scan_from_upperbound ||
  ...
  const bool cursor_stream_read = mode == async_read_cursor_get_batch ||
                                  ...
                                  mode == async_read_cursor_get_loop_from_lt ||
                                  mode == async_read_cursor_get_loop_from_lte ||
                                  ...
                                  mode == async_read_cursor_get_batches_from_lt ||
                                  mode == async_read_cursor_get_batches_from_lte ||
                                  ...
                                  mode == async_read_cursor_scan_from_lt ||
                                  mode == async_read_cursor_scan_from_lte ||
  ...
  const bool to_key_lt_read = mode == async_read_sync_cursor_get_to_key_lt ||
                              mode == async_read_cursor_get_to_key_lt;
  const bool to_key_lte_read = mode == async_read_sync_cursor_get_to_key_lte ||
  ...
  const bool cursor_from_exclusive_read =
      ...
      mode == async_read_sync_cursor_scan_from_gt ||
      mode == async_read_sync_cursor_scan_from_upperbound;
  const bool cursor_from_lesser_or_equal_read =
      mode == async_read_cursor_get_loop_from_lte ||
      mode == async_read_cursor_get_batches_from_lte ||
      mode == async_read_cursor_scan_from_lte ||
      mode == async_read_sync_cursor_scan_from_lte;
  const size_t cursor_stream_target =
      (cursor_from_exclusive_read || cursor_from_lesser_or_equal_read)
  ...
  const bool large_read = mode == async_read_large_get ||
                          ...
                          mode == async_read_sync_large_cursor_get ||
                          mode == async_read_sync_large_cursor_batch ||
                          mode == async_read_large_cursor_get ||
  ...
  if (cursor_from_exclusive_read || cursor_from_lesser_or_equal_read)
  ...
  else if (upperbound_read || to_key_lt_read || to_key_lte_read ||
           to_key_equal_read || to_key_gte_read || to_key_gt_read)
  ...
  if (mode == async_read_sync_get) {
  ...
  } else if (mode == async_read_sync_large_get) {
    read_name = "mdbx_get cold sync large read";
  } else if (mode == async_read_sync_large_get_ex) {
    read_name = "mdbx_get_ex cold sync large read";
  } else if (mode == async_read_sync_large_lowerbound) {
    read_name = "mdbx_get_equal_or_great cold sync large read";
  } else if (mode == async_read_sync_large_cursor_get) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_get cold sync large read";
  } else if (mode == async_read_sync_large_cursor_batch) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_get_batch cold sync large read";
  } else if (mode == async_read_sync_large_cursor_scan) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan cold sync large read";
  ...
  } else if (mode == async_read_sync_cursor_get_to_key_lt) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_get TO_KEY_LESSER_THAN cold sync read";
  } else if (mode == async_read_sync_cursor_get_to_key_lte) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_get TO_KEY_LESSER_OR_EQUAL cold sync read";
  ...
  } else if (mode == async_read_sync_cursor_scan_from_lt) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from TO_KEY_LESSER_THAN cold sync read";
  } else if (mode == async_read_sync_cursor_scan_from_lte) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from TO_KEY_LESSER_OR_EQUAL cold sync read";
  } else if (mode == async_read_sync_cursor_scan_from_equal) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from TO_KEY_EQUAL cold sync read";
  } else if (mode == async_read_sync_cursor_scan_from_gte) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from TO_KEY_GREATER_OR_EQUAL cold sync read";
  } else if (mode == async_read_sync_cursor_scan_from_gt) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from TO_KEY_GREATER_THAN cold sync read";
  } else if (mode == async_read_sync_cursor_scan_from_upperbound) {
    CHECK(mdbx_cursor_open(txn, dbi, &cursor));
    read_name = "mdbx_cursor_scan_from SET_UPPERBOUND cold sync read";
    ...
    if (mode == async_read_large_cursor_get)
      read_name = "mdbx_async_cursor_get cold large single read";
    else if (mode == async_read_cursor_get_miss)
    ...
    else if (mode == async_read_cursor_get_to_key_lt)
      read_name = "mdbx_async_cursor_get TO_KEY_LESSER_THAN cold single read";
    else if (mode == async_read_cursor_get_to_key_lte)
      read_name = "mdbx_async_cursor_get TO_KEY_LESSER_OR_EQUAL cold single read";
    ...
    else if (mode == async_read_cursor_get_loop_from_lt)
      read_name = "mdbx_async_cursor_get_loop_from TO_KEY_LESSER_THAN cold read";
    else if (mode == async_read_cursor_get_loop_from_lte)
      read_name = "mdbx_async_cursor_get_loop_from TO_KEY_LESSER_OR_EQUAL cold read";
    ...
    else if (mode == async_read_cursor_get_batches_from_lt)
      read_name = "mdbx_async_cursor_get_batches_from TO_KEY_LESSER_THAN cold read";
    else if (mode == async_read_cursor_get_batches_from_lte)
      read_name = "mdbx_async_cursor_get_batches_from TO_KEY_LESSER_OR_EQUAL cold read";
    ...
    else if (mode == async_read_cursor_scan_from_lt)
      read_name = "mdbx_async_cursor_scan_from TO_KEY_LESSER_THAN cold read";
    else if (mode == async_read_cursor_scan_from_lte)
      read_name = "mdbx_async_cursor_scan_from TO_KEY_LESSER_OR_EQUAL cold read";
  ...
  if (mode == async_read_abort_order) {
    ...
    rc = mdbx_cursor_get_batch(cursor, &cursor_batch_count, cursor_batch_pairs, 4,
                               MDBX_FIRST);
  } else if (mode == async_read_sync_large_cursor_scan) {
    rc = mdbx_cursor_scan(cursor, async_read_large_cursor_scan_result_func,
                          &large_cursor_probe, MDBX_FIRST, MDBX_NEXT, NULL);
  }
  else if (mode == async_read_sync_cursor_get ||
           mode == async_read_sync_cursor_get_miss)
    rc = mdbx_cursor_get(cursor, read_key_value, &data, MDBX_SET_KEY);
    ...
    rc = mdbx_cursor_get(cursor, read_key_value, &data, MDBX_TO_KEY_LESSER_THAN);
  else if (mode == async_read_sync_cursor_get_to_key_lte)
    rc = mdbx_cursor_get(cursor, read_key_value, &data, MDBX_TO_KEY_LESSER_OR_EQUAL);
  else if (mode == async_read_sync_cursor_get_to_key_equal ||
           mode == async_read_sync_cursor_get_to_key_equal_miss)
    ...
    cursor_from_key = batch_key_values[1];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_TO_KEY_LESSER_THAN, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_lte) {
    cursor_from_key = batch_key_values[1];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_TO_KEY_LESSER_OR_EQUAL, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_equal) {
    cursor_from_key = batch_key_values[0];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_TO_KEY_EQUAL, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_gte) {
    cursor_from_key = batch_key_values[0];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_TO_KEY_GREATER_OR_EQUAL, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_gt) {
    cursor_from_key = batch_key_values[0];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_TO_KEY_GREATER_THAN, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_upperbound) {
    cursor_from_key = batch_key_values[0];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_cursor_scan_from(cursor, async_read_cursor_scan_result_func, &loop_read_probe,
                               MDBX_SET_UPPERBOUND, &cursor_from_key, &cursor_from_data,
                               MDBX_NEXT, NULL);
  } else if (mode == async_read_sync_cursor_scan_from_nodup) {
    cursor_from_key = batch_key_values[0];
    cursor_from_data = val(NULL, 0);
  ...
  } else if (mode == async_read_large_cursor_get) {
    ...
    rc = mdbx_async_cursor_get(async, cursor, read_key_value, &data,
                               MDBX_TO_KEY_LESSER_THAN, &op);
  else if (mode == async_read_cursor_get_to_key_lte)
    rc = mdbx_async_cursor_get(async, cursor, read_key_value, &data,
                               MDBX_TO_KEY_LESSER_OR_EQUAL, &op);
  else if (mode == async_read_cursor_get_to_key_equal ||
           mode == async_read_cursor_get_to_key_equal_miss)
    ...
    cursor_from_data = val(NULL, 0);
    rc = mdbx_async_cursor_get_loop_from(async, cursor, cursor_stream_target,
                                         MDBX_TO_KEY_LESSER_THAN, &cursor_from_key,
                                         &cursor_from_data, MDBX_NEXT,
                                         async_read_cursor_loop_result_func,
                                         &loop_read_probe, &cursor_stream_completed, &op);
  } else if (mode == async_read_cursor_get_loop_from_lte) {
    ...
    cursor_from_data = val(NULL, 0);
    rc = mdbx_async_cursor_get_loop_from(async, cursor, cursor_stream_target,
                                         MDBX_TO_KEY_LESSER_OR_EQUAL, &cursor_from_key,
                                         &cursor_from_data, MDBX_NEXT,
                                         async_read_cursor_loop_result_func,
                                         &loop_read_probe, &cursor_stream_completed, &op);
  } else if (mode == async_read_cursor_get_loop_from_equal) {
    ...
    cursor_from_data = val(NULL, 0);
    rc = mdbx_async_cursor_scan_from(async, cursor, async_read_cursor_scan_result_func,
                                     &loop_read_probe, MDBX_TO_KEY_LESSER_THAN,
                                     &cursor_from_key, &cursor_from_data, MDBX_NEXT,
                                     NULL, &op);
  } else if (mode == async_read_cursor_scan_from_lte) {
    cursor_from_key = batch_key_values[1];
    cursor_from_data = val(NULL, 0);
    rc = mdbx_async_cursor_scan_from(async, cursor, async_read_cursor_scan_result_func,
                                     &loop_read_probe, MDBX_TO_KEY_LESSER_OR_EQUAL,
                                     &cursor_from_key, &cursor_from_data, MDBX_NEXT,
                                     NULL, &op);
  } else if (mode == async_read_cursor_scan_from_equal) {
    cursor_from_key = batch_key_values[0];
  ...
  if (rc != MDBX_SUCCESS)
    goto bailout;
  if (inject_fault) {
    if (mode == async_read_get || mode == async_read_sync_get ||
        mode == async_read_sync_lowerbound ||
        mode == async_read_large_get ||
        mode == async_read_large_lowerbound ||
        mode == async_read_large_cursor_get ||
        mode == async_read_sync_large_get ||
        mode == async_read_sync_large_lowerbound ||
    ...
    } else if (mode == async_read_cache_get_many_mixed ||
               mode == async_read_cache_get_singlethreaded_many_mixed) {
      REQUIRE(operation_result == MDBX_SUCCESS,
              "faulted mixed async cache get many operation returned wrong result");
      bool saw_eio = false;
      for (unsigned i = 0; i < ASYNC_READ_BATCH_COUNT; ++i) {
        const bool missing = i == 1;
        saw_eio = saw_eio || many_operation_results[i] == MDBX_EIO ||
        ...
        REQUIRE(missing ? (many_operation_results[i] == MDBX_NOTFOUND ||
                           async_read_fault_result(many_operation_results[i]))
                        : async_read_fault_result(many_operation_results[i]),
                "faulted mixed async cache get many returned wrong operation result");
        REQUIRE(missing ? (batch_cache_results[i].errcode == MDBX_NOTFOUND ||
                           async_read_fault_result(batch_cache_results[i].errcode))
                        : async_read_fault_result(batch_cache_results[i].errcode),
                "faulted mixed async cache get many returned wrong item result");
        if (batch_cache_results[i].errcode == MDBX_EIO ||
            batch_cache_results[i].errcode == MDBX_BAD_TXN)
          REQUIRE(batch_cache_results[i].status == MDBX_CACHE_ERROR,
                  "faulted mixed async cache get many returned wrong cache status");
        CHECK(expect_empty_value(&batch_data[i], __FILE__, __LINE__));
      }
      REQUIRE(saw_eio, "faulted mixed async cache get many did not observe injected read failure");
    } else if (mode == async_read_cache_get_batch ||
               mode == async_read_cache_get_singlethreaded_batch ||
               mode == async_read_large_cache_get_batch ||
               mode == async_read_large_cache_get_singlethreaded_batch) {
    ...
    } else if (mode == async_read_cache_get_batch_mixed ||
               mode == async_read_cache_get_singlethreaded_batch_mixed) {
      REQUIRE(operation_result == MDBX_SUCCESS,
              "faulted mixed async cache get batch operation returned wrong result");
      bool saw_eio = false;
      for (unsigned i = 0; i < ASYNC_READ_BATCH_COUNT; ++i) {
        const bool missing = i == 1;
        saw_eio = saw_eio || batch_cache_results[i].errcode == MDBX_EIO;
        REQUIRE(missing ? (batch_cache_results[i].errcode == MDBX_NOTFOUND ||
                           async_read_fault_result(batch_cache_results[i].errcode))
                        : async_read_fault_result(batch_cache_results[i].errcode),
                "faulted mixed async cache get batch returned wrong item result");
        if (batch_cache_results[i].errcode == MDBX_EIO ||
            batch_cache_results[i].errcode == MDBX_BAD_TXN)
          REQUIRE(batch_cache_results[i].status == MDBX_CACHE_ERROR,
                  "faulted mixed async cache get batch returned wrong cache status");
        CHECK(expect_empty_value(&batch_data[i], __FILE__, __LINE__));
      }
      REQUIRE(saw_eio, "faulted mixed async cache get batch did not observe injected read failure");
    } else if (mode == async_read_get_loop ||
               mode == async_read_large_get_loop) {
      REQUIRE(operation_result == MDBX_SUCCESS,
      ...
      CHECK(expect_empty_value(&data, __FILE__, __LINE__));
               ...
               mode == async_read_sync_large_cursor_batch) {
      REQUIRE(operation_result == MDBX_EIO,
              "faulted cursor get batch did not propagate read-completion failure");
      ...
      REQUIRE(cursor_stream_completed == 0,
              "faulted large cursor stream completed items");
      REQUIRE(large_cursor_probe.results == 0,
              "faulted large cursor stream invoked callback");
    } else if (mode == async_read_cursor_get_loop ||
               mode == async_read_cursor_get_loop_prev ||
               mode == async_read_cursor_get_loop_current ||
               mode == async_read_cursor_get_loop_current_prev ||
    ...
    if (cache_single_read) {
      ...
      REQUIRE(memcmp(data.iov_base, batch_values[1], sizeof(batch_values[1])) == 0,
              "cold sync cursor get NEXT_NODUP returned wrong value");
               ...
               mode == async_read_sync_large_lowerbound ||
               mode == async_read_sync_large_cursor_get) {
      if (mode == async_read_sync_large_cursor_get ||
          mode == async_read_large_cursor_get) {
        REQUIRE(read_key_value->iov_len == sizeof(key),
                "cold large cursor get returned wrong key size");
        uint64_t actual_key = UINT64_MAX;
        memcpy(&actual_key, read_key_value->iov_base, sizeof(actual_key));
        REQUIRE(actual_key == key, "cold large cursor get returned wrong key");
      }
      CHECK(expect_large_value(&data, key, __FILE__, __LINE__));
    } else if (mode == async_read_large_get_ex ||
               mode == async_read_sync_large_get_ex) {
      REQUIRE(values_count == 1,
              "cold large get_ex returned wrong value count");
      REQUIRE(read_key_value->iov_len == sizeof(key),
              "cold large get_ex returned wrong key size");
      uint64_t actual_key = UINT64_MAX;
      memcpy(&actual_key, read_key_value->iov_base, sizeof(actual_key));
      REQUIRE(actual_key == key, "cold large get_ex returned wrong key");
      CHECK(expect_large_value(&data, key, __FILE__, __LINE__));
    } else if (mode == async_read_large_get_many) {
      for (unsigned i = 0; i < indexed_read_count; ++i) {
      ...
      CHECK(expect_payload(&data, payload, __FILE__, __LINE__));
               ...
               mode == async_read_cursor_get_to_key_gt) {
      REQUIRE(read_key_value->iov_len == sizeof(batch_keys[forward_seek_expected_index]),
              "cold async cursor get key seek returned wrong key size");
      uint64_t actual_key = UINT64_MAX;
      memcpy(&actual_key, read_key_value->iov_base, sizeof(actual_key));
      REQUIRE(actual_key == batch_keys[forward_seek_expected_index],
              "cold async cursor get key seek returned wrong key");
      REQUIRE(data.iov_len == sizeof(batch_values[forward_seek_expected_index]),
              "cold async cursor get key seek returned wrong value size");
      REQUIRE(memcmp(data.iov_base, batch_values[forward_seek_expected_index],
                     sizeof(batch_values[forward_seek_expected_index])) == 0,
              "cold async cursor get key seek returned wrong value");
    } else if (mode == async_read_cursor_get_prev_positioned) {
      const unsigned expected_index = ASYNC_READ_BATCH_COUNT - 2;
      ...
      if (mode == async_read_cursor_get_batches_current ||
          ...
          mode == async_read_cursor_get_batches_from_gt ||
          mode == async_read_cursor_get_batches_from_upperbound) {
        const size_t expected_final_index = ASYNC_READ_BATCH_COUNT - 1;
        REQUIRE(cursor_from_key.iov_len == sizeof(batch_keys[expected_final_index]),
...
int main(void) {
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_GET_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_get);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_GET_EX_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_get_ex);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_LOWERBOUND_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_lowerbound);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_CURSOR_GET_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_cursor_get);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_CURSOR_BATCH_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_cursor_batch);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_LARGE_CURSOR_SCAN_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_large_cursor_scan);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_GET_TO_KEY_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_get_to_key_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_GET_TO_KEY_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_get_to_key_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_lte);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_EQUAL_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_equal);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_GTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_gte);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_GT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_gt);
  if (env_enabled("MDBX_ASYNC_SMOKE_SYNC_CURSOR_SCAN_FROM_UPPERBOUND_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_sync_cursor_scan_from_upperbound);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_TO_KEY_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_to_key_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_TO_KEY_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_to_key_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_LARGE_CURSOR_GET_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_large_cursor_get);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_LOOP_FROM_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_loop_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_LOOP_FROM_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_loop_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_BATCHES_FROM_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_batches_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_BATCHES_FROM_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_get_batches_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_SCAN_FROM_LT_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_scan_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_CURSOR_SCAN_FROM_LTE_READ_ONLY"))
    return exercise_async_read_path(path, false, async_read_cursor_scan_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CACHE_MANY_MIXED_ONLY"))
    return exercise_async_read_path(path, true, async_read_cache_get_many_mixed);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CACHE_ST_MANY_MIXED_ONLY"))
    return exercise_async_read_path(path, true, async_read_cache_get_singlethreaded_many_mixed);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CACHE_BATCH_MIXED_ONLY"))
    return exercise_async_read_path(path, true, async_read_cache_get_batch_mixed);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CACHE_ST_BATCH_MIXED_ONLY"))
    return exercise_async_read_path(path, true, async_read_cache_get_singlethreaded_batch_mixed);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_GET_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_get);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_GET_EX_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_get_ex);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_LOWERBOUND_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_lowerbound);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_MISS_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_miss);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_SET_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_set);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_RANGE_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_range);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_UPPERBOUND_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_upperbound);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_LT_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_LTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_lte);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_EQUAL_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_equal);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_EQUAL_MISS_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_equal_miss);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_GTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_gte);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_TO_KEY_GT_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_to_key_gt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_LAST_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_last);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_PREV_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_get_prev);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_GET_PREV_POSITIONED_ONLY"))
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_LARGE_CURSOR_BATCH_ONLY"))
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_PREV_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_prev);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_LT_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_LTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_lte);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_EQUAL_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_equal);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_GTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_gte);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_GT_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_gt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_UPPERBOUND_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_upperbound);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_SYNC_CURSOR_SCAN_FROM_NODUP_ONLY"))
    return exercise_async_read_path(path, true, async_read_sync_cursor_scan_from_nodup);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_LARGE_CURSOR_GET_ONLY"))
    return exercise_async_read_path(path, true, async_read_large_cursor_get);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_LOOP_NODUP_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_loop_nodup);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_LOOP_FROM_LT_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_loop_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_LOOP_FROM_LTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_loop_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_LOOP_FROM_NODUP_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_loop_from_nodup);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_BATCHES_FROM_LT_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_batches_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_BATCHES_FROM_LTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_get_batches_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_SCAN_NODUP_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_scan_nodup);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_SCAN_FROM_LT_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_scan_from_lt);
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_SCAN_FROM_LTE_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_scan_from_lte);
  ...
  if (env_enabled("MDBX_ASYNC_SMOKE_READ_FAULT_CURSOR_SCAN_FROM_NODUP_ONLY"))
    return exercise_async_read_path(path, true, async_read_cursor_scan_from_nodup);
